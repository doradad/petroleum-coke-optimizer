...
exports.LinearProgrammingSolver = void 0;
class LinearProgrammingSolver {
    ...
    findEnteringVariable(tableau, m) {
    ...
    findLeavingVariable(tableau, enteringVar, m) {
    ...
    extractSolution(tableau, basicVars, originalVars, iterations) {
...
exports.LinearProgrammingSolver = LinearProgrammingSolver;
